...
def print_banner():
    print(f"{COLOR_MAGENTA}Portal Setup{COLOR_RESET}")
    print()
...
def main():
    ...
    try:
        ...
        logging.info("=" * 50)
        logging.info("%sPortal status: running%s", COLOR_YELLOW, COLOR_RESET)
        logging.info("SSID: %s", AP_SSID)
        logging.info("=" * 50)
        logging.info("%sPress Ctrl+C to stop%s", COLOR_YELLOW, COLOR_RESET)
